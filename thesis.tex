...
% Required data.
\setaddress{Address}
\setregnumber{e1638889}
\setdate{01}{01}{2001} % Set date with 3 arguments: {day}{month}{year}.
\settitle{\thesistitle}{German title} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
...
\input{sections/relevance.tex}


\chapter{Background}
This is background chapter.	
\section{Brief introduction to Machine Learning}
\input{sections/brief-introduction.tex}
\section{Neural networks}
\input{sections/neural-networks.tex}
